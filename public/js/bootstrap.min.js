...
+(function (t) {
          ...
          setTimeout(
            t.proxy(function () {
              o[n](null == s[e] ? this.options[e] : s[e]),
                'loadingText' == e
                  ? ((this.isLoading = !0), o.addClass(i).attr(i, i).prop(i, !0))
        ...
        if (e.length) {
          ...
          'radio' == i.prop('type')
            ...
            : 'checkbox' == i.prop('type') &&
              (i.prop('checked') !== this.$element.hasClass('active') && (t = !1), this.$element.toggleClass('active')),
        ...
        .on('click.bs.button.data-api', '[data-toggle^="button"]', function (i) {
          ...
          e.call(o, 'toggle'),
            t(i.target).is('input[type="radio"], input[type="checkbox"]') ||
              ...
              o.is('input,button')
                ? o.trigger('focus')
                : o.find('input:visible,button:visible').first().trigger('focus'));
        })
    ...
    (i.VERSION = '3.4.1'),
      ...
      (i.prototype.backdrop = function (e) {
        ...
        if (this.isShown && this.options.backdrop) {
          ...
          t.support.transition && this.$element.hasClass('fade')
            ? this.$backdrop.one('bsTransitionEnd', a).emulateTransitionEnd(i.BACKDROP_TRANSITION_DURATION)
            : a();
        } else e && e();
      }),
    ...
    function o(e) {
      return this.each(function () {
        ...
        (!o && /destroy|hide/.test(e)) ||
          (o || i.data('bs.tooltip', (o = new d(this, n))), 'string' == typeof e && o[e]());
      });
    }
    ...
    (d.VERSION = '3.4.1'),
      ...
      (d.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          t.support.transition && this.$tip.hasClass('fade')
            ? n.one('bsTransitionEnd', m).emulateTransitionEnd(d.TRANSITION_DURATION)
            : m();
        }
      }),
      ...
      (d.prototype.setContent = function () {
        var t = this.tip(),
          e = this.getTitle();
        this.options.html
          ? (this.options.sanitize && (e = i(e, this.options.whiteList, this.options.sanitizeFn)),
          ...
          s.isDefaultPrevented()
            ...
            : (n.removeClass('in'),
              t.support.transition && n.hasClass('fade')
                ? n.one('bsTransitionEnd', i).emulateTransitionEnd(d.TRANSITION_DURATION)
                : i(),
              (this.hoverState = null),
              this)
        );
  ...
  +(function (t) {
    ...
    var i = function (e, o) {
      ...
      var n =
        this.options.target === i.DEFAULTS.target ? t(this.options.target) : t(document).find(this.options.target);
      (this.$target = n
