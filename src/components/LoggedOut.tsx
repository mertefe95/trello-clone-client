    ...
    <div className="logged-out-outer-container">
      ...
      <main className="logged-out-main-container">
        ...
        <div className="mt-xl-5 mt-md-5 shared-comp-row d-flex flex-column align-items-center justify-content-center">
          <div className="mt-md-3 ml-xl-0 ml-lg-5 pl-xl-4 pl-lg-0 pl-md-5 logged-out-shared-comp-div col-xl-12 col-lg-10 col-md-10 d-flex flex-column align-items-center justify-content-center">
            ...
            <button className="btn btn-light font-weight-bold ml-md-0 ml-2">Remove Saved Preferences</button>
          </div>
        </div>
        <div className="py-md-5 px-md-5 app-row d-flex align-items-center justify-content-center">
          <div className="d-flex justify-content-center align-items-center app-row-div">
            <div className="mt-md-5 logged-out-app-img-div col-md-5 col-xl-5 col-12">
              <img
            ...
            <div className="d-flex flex-column app-row-text-div col-md-5">
              <p>
        ...
        <div className="logged-out-gold-row d-flex justify-content-center align-items-center flex-column">
          <div className="col-xl-6 col-lg-8 col-md-9 mt-lg-0 mt-md-3 ml-xl-5 ml-lg-4 ml-md-4 pl-xl-5 px-md-5 text-center d-flex justify-content-center align-items-center flex-column">
            ...
            <button className="btn btn-light py-md-2 ml-md-0 ml-2">Share Trello</button>
        ...
        <div className="logged-out-blue-row d-flex justify-content-center align-items-center">
          <div className="col-xl-12 col-lg-12 col-md-8 pt-xl-0 pt-lg-5 pl-xl-5 pl-lg-5 ml-xl-3 ml-lg-0 ml-md-4 d-flex justify-content-center align-items-center flex-column">
