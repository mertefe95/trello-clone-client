...
const Header: FunctionComponent = function () {
  return (
    <nav className="nav">
        ...
        <Link to="/homepage">
          ...
          >
            ...
            <g fill="none" fillRule="evenodd">
              ...
              ></path>
              <g fill="#293856" fillRule="nonzero" transform="translate(87)">
      ...
      <div className="nav-rightside position-relative mr-5">
        <Link className="homepage-login-link" to="/">
          Log in
        </Link>
        <Link className="ml-3 homepage-signup-link" to="/">
          Sign Up
        </Link>
      </div>

      <div className="upper-homepage"></div>
    </nav>
  );
};
